...
export const WETH9: TokenMap = {
  ...
  [ChainId.FLARE]: new Token(ChainId.FLARE, WETH9_ADDRESS[ChainId.FLARE], 18, 'WETH', 'Wrapped Ether'),
  [ChainId.COSTON]: new Token(ChainId.COSTON, WETH9_ADDRESS[ChainId.COSTON], 18, 'WETH', 'Wrapped Ether'),
  [ChainId.SONGBIRD]: new Token(ChainId.SONGBIRD, WETH9_ADDRESS[ChainId.SONGBIRD], 18, 'WETH', 'Wrapped Ether'),
}
...
export const WNATIVE: TokenMap = {
  ...
  [ChainId.FLARE]: new Token(ChainId.FLARE, WNATIVE_ADDRESS[ChainId.FLARE], 18, 'WFLR', 'Wrapped Flare'),
  [ChainId.COSTON]: new Token(ChainId.COSTON, WNATIVE_ADDRESS[ChainId.COSTON], 18, 'WCFLR', 'Wrapped Coston'),
  [ChainId.SONGBIRD]: new Token(ChainId.SONGBIRD, WNATIVE_ADDRESS[ChainId.SONGBIRD], 18, 'WSGB', 'Wrapped Songbird'),
}
...
export const SUSHI: ChainTokenMap = {
  ...
  [ChainId.FLARE]: new Token(ChainId.FLARE, SUSHI_ADDRESS[ChainId.FLARE], 18, 'SUSHI', 'SushiToken'),
  [ChainId.COSTON]: new Token(ChainId.COSTON, SUSHI_ADDRESS[ChainId.COSTON], 18, 'SUSHI', 'SushiToken'),
  [ChainId.SONGBIRD]: new Token(ChainId.SONGBIRD, SUSHI_ADDRESS[ChainId.SONGBIRD], 18, 'SUSHI', 'SushiToken'),
}
