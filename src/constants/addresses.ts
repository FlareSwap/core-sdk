...
export const SUSHI_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x17Ee7E4dA37B01FC1bcc908fA63DF343F23B4B7C', // replace
  [ChainId.COSTON]: '0xF328362C39975B8dc3C0609E19812B4b2F97EA86',
  [ChainId.SONGBIRD]: '0x17Ee7E4dA37B01FC1bcc908fA63DF343F23B4B7C', // replace
}
...
export const WETH9_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x06B7F5AA6B0DECb7dc8A3744ADaB3d626F08A55C', // replace
  [ChainId.COSTON]: '0x06B7F5AA6B0DECb7dc8A3744ADaB3d626F08A55C',
  [ChainId.SONGBIRD]: '0x06B7F5AA6B0DECb7dc8A3744ADaB3d626F08A55C', // replace
}
...
export const WNATIVE_ADDRESS: AddressMap = {
  ...
  [ChainId.COSTON]: '0x1659941d425224408c5679eeef606666c7991a8A',
  [ChainId.SONGBIRD]: '0x02f0826ef6aD107Cfc861152B32B52fD11BaB9ED',
}
...
export const FACTORY_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0xFf52EEc2832eA2e78a2339C44b15619A6807BFb1', // replace
  [ChainId.COSTON]: '0xFf52EEc2832eA2e78a2339C44b15619A6807BFb1',
  [ChainId.SONGBIRD]: '0xFf52EEc2832eA2e78a2339C44b15619A6807BFb1', // replace
}
...
export const ROUTER_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x3e333e92AA28dFeCF9fd9850b4bf8e821522642c', // replace
  [ChainId.COSTON]: '0x3e333e92AA28dFeCF9fd9850b4bf8e821522642c',
  [ChainId.SONGBIRD]: '0x3e333e92AA28dFeCF9fd9850b4bf8e821522642c', // replace
}
...
export const MASTERCHEF_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x742c3c55c67Fd37eaF4C1b7048D17556544855D7', // replace
  [ChainId.COSTON]: '0x742c3c55c67Fd37eaF4C1b7048D17556544855D7',
  [ChainId.SONGBIRD]: '0x742c3c55c67Fd37eaF4C1b7048D17556544855D7', // replace
}
...
export const BAR_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x1be211D8DA40BC0ae8719c6663307Bfc987b1d6c', // replace
  [ChainId.COSTON]: '0x291AeCea5512A2A74a08AaEcB057aDc7D293a578',
  [ChainId.SONGBIRD]: '0x1be211D8DA40BC0ae8719c6663307Bfc987b1d6c', // replace
}
...
export const MAKER_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x1b9d177CcdeA3c79B6c8F40761fc8Dc9d0500EAa', // replace
  [ChainId.COSTON]: '0x5B04CE654F09f258574Ad897416Cef105A55c194',
  [ChainId.SONGBIRD]: '0x1b9d177CcdeA3c79B6c8F40761fc8Dc9d0500EAa', // replace
}
...
export const MINICHEF_ADDRESS: AddressMap = {
  ...
  [ChainId.FLARE]: '0x1334c8e873E1cae8467156e2A81d1C8b566B2da1', // replace
  [ChainId.COSTON]: '0xE0CF49c1ed0D1c17F8f080638Da6C68a2c53AeB2',
  [ChainId.SONGBIRD]: '0x1334c8e873E1cae8467156e2A81d1C8b566B2da1', // replace
}
