...
(function (ChainKey) {
  ...
  ChainKey["FLARE"] = "flare";
  ChainKey["COSTON"] = "coston";
  ChainKey["SONGBIRD"] = "songbird";
...
var Flare = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Flare, _NativeCurrency);

  function Flare(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'FLR', 'Flare') || this;
  }

  Flare.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Flare(chainId);
  };

  var _proto = Flare.prototype;
...
var Coston = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Coston, _NativeCurrency);

  function Coston(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'CFLR', 'Coston') || this;
  }

  Coston.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Coston(chainId);
  };

  var _proto = Coston.prototype;
